...
function App() {
  ...
  const getWeather = async (location) => {
    ...
    let how_to_search = (typeof location === 'string') ? `q=${location}` : `lat=${location[0]}&long=${location[1]}`
  ...
  return (
    <div className="bg-gray-800 flex items-center justify-center w-screen h-full py-10" id="principal-container">

      <div id="secondary-container" className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto h-auto bg-gray-100">
        ...
        <div id="form-container">
          <div className="flex items-center justify-center">
            ...
            <div className="flex p-2 text-gray-100 bg-gray-600 bg-opacity-30 rounded-lg">
              ...
              <i className="bi bi-map-fill my-auto" aria-hidden="true"></i>
            ...
            <form noValidate onSubmit={handleSubmit} className="flex justify-center w-full">
              ...
              />
                ...
                <button type="submit" className="z-10">
                  ...
                  <i className="bi bi-search text-white -ml-10 border-l my-auto z-10 cursor-pointer p-3" 
                  aria-hidden="true" type="submit"></i>

                </button>

              <i className="bi bi-geo-alt-fill my-auto cursor-pointer p-3 text-white" aria-hidden="true" onClick={() => {
          ...
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? 
              ...
              <>
                ...
                <h2 className="text-3xl text-gray-600 mb-4 mt-10">More On {city}</h2>
